        ...
        public Vector3 UpdatePosition(Vector3 currentPosition)
        {
            ...
            switch (m_Model.InterpolateOption)
            {
                ...
                case PhotonTransformViewPositionModel.InterpolateOptions.SynchronizeValues:
                    ...
                    {
                        currentPosition = Vector3.MoveTowards(currentPosition, targetPosition, Time.smoothDeltaTime * m_SynchronizedSpeed.magnitude);
                    }

                    break;

                case PhotonTransformViewPositionModel.InterpolateOptions.Lerp:
                    currentPosition = Vector3.Lerp(currentPosition, targetPosition, Time.smoothDeltaTime * m_Model.InterpolateLerpSpeed);
                    break;
            }
