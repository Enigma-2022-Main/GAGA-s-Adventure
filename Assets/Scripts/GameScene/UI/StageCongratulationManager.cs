...
public class StageCongratulationManager : MonoBehaviour
{
    ...
    private void Update()
    {
        text3.text = TimerController.HighestStageTimerText;
        //Debug.Log("visualizeStageCongratulation: " + visualizeStageCongratulationFlag);
        if (visualizeStageCongratulationFlag)
        {
            ...
            if (GameStageManager.IsCleared == true)
            {
                text1.text = "게임 클리어!";
                text2.text = "- 축하합니다! -";
            }
            ...
            {
                if (GameStageManager.PlayerHighestStage != 7)
                    text1.text = (GameStageManager.PlayerHighestStage + 1).ToString() + "스테이지";
                else
                    text1.text = "마지막 스테이지";
                text2.text = ("- " + subNames[GameStageManager.PlayerHighestStage] + " -");
            }
